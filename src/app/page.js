   ...
   <div className={styles.Home}>
      <div className={styles.HomeCon}>
        ...
        <h3 className={styles.H3}>Réussis tes études avec notre plateforme de cours en ligne!</h3>
          <p className={styles.P}> Des cours interactifs et adaptés au programme scolaire gabonais pour taider à exceller en classe et aux examens.</p>
          <a href="#" className={styles.Btn}>
                      <span className={styles.Text}>Inscris-toi maintenant</span>
                      <span  className={styles.Text} >Commence laventure</span>
                  </a> 
